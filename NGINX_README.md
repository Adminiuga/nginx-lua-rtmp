# Nginx with Lua and RTMP Modules

This repository contains a custom nginx Docker image based on the official nginx mainline image with additional modules:
